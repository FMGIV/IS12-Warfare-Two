...
/datum/unarmed_attack/proc/handle_eye_attack(var/mob/living/carbon/human/user, var/mob/living/carbon/human/target)
	...
	if(eyes)
		var/eyedamage = rand(3,4)
		eyes.take_damage(eyedamage, 1)
		user.visible_message("<span class='combat_success'>[user] presses \his fingers into [target]'s [eyes.name]!</span>")
		...
		target.attack_bloody(null, user, eyedamage, BP_EYES)  
		return 1
